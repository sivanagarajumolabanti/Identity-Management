...
class BasePropertyComponent extends _react.default.Component {
  shouldComponentUpdate(nextProps) {
    ...
    return !(0, _isEqual.default)(nextProps.record, (_this$props = this.props) === null || _this$props === void 0 ? void 0 : _this$props.record);
  }
  ...
  render() {
    ...
    if (property.components && property.components[where]) {
      ...
      return _react.default.createElement(_errorBoundary.default, null, _react.default.createElement(_designSystem.Box, {
        "data-testid": testId
