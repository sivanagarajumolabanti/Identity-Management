...
const BulkAction = () => {
  ...
  if (action.showInDrawer) {
    return _react.default.createElement(_drawerPortal.default, null, _react.default.createElement(_baseActionComponent.default, {
      action: action,
      resource: resource,
      records: records
    }));
  ...
  return _react.default.createElement(_wrapper.default, null, !(action === null || action === void 0 ? void 0 : action.showInDrawer) ? _react.default.createElement(_app.ActionHeader, {
    resource: resource,
    action: action
